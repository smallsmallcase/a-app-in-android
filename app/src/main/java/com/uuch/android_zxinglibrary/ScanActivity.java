...
public class ScanActivity extends BaseActivity implements EasyPermissions.PermissionCallbacks{
    ...
    public String data2;//定义装载解析结果的变量
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.button_add).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(ScanActivity.this,Vegetible_Search.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        /**            switch (result){
                        ...
                        case "mango":
                            break;
                        default:
                            startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse(result)));//待删
                    }
***/

                } else if (bundle.getInt(CodeUtils.RESULT_TYPE) == CodeUtils.RESULT_FAILED) {
                    Toast.makeText(ScanActivity.this, "解析二维码失败，搜索不到该物种", Toast.LENGTH_LONG).show();
                }
    ...
    class ButtonOnClickListener implements View.OnClickListener{
        ...
        public void onClick(View v) {
            if (v.getId() == R.id.button2) {
                ...
                Intent intent = new Intent(ScanActivity.this, ThreeActivity.class);
                startActivity(intent);
            } else {
                cameraTask(buttonId);
            }
    ...
    private void onClick(int buttonId) {
        switch (buttonId) {
            case R.id.button1:
                ...
                break;
            case R.id.button3:
                intent = new Intent(ScanActivity.this, SecondActivity.class);
                startActivityForResult(intent, REQUEST_CODE);
                break;
            default:
                break;
